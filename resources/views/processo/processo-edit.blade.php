        ...
        <div class="card-body">
            <form action="/processo" method="post" class="d-flex flex-column">
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control col-8" type="text" name="numeroProcesso" id="numeroProcesso" value="{{$processo->numeroProcesso}}">
                </div>

                <div class="form-group row">
                    <label for="autor" class="col-4 col-form-label">Autor: </label>
                    <input class="form-control col-8" type="text" name="autor" id="autor" value="{{$processo->autor}}">
                </div>

                <div class="form-group row">
                    <label for="vara" class="col-4 col-form-label">Vara: </label>
                    <input class="form-control col-8" type="text" name="vara" id="vara" value="{{$processo->vara}}">
                </div>
